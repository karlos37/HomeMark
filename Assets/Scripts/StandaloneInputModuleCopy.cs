...
namespace UnityEngine.EventSystems
{
	...
	/// </remarks>
	public class StandaloneInputModuleCopy : PointerInputModule
	{
		...
		protected StandaloneInputModuleCopy()
		{
		}
		...
		public override bool ShouldActivateModule()
		{
			...
			shouldActivate |= !Mathf.Approximately(input.GetAxisRaw(m_VerticalAxis) * -1, 0.0f);
		...
		private Vector2 GetRawMoveVector()
		{
			...
			move.y = input.GetAxisRaw(m_VerticalAxis) * -1;
